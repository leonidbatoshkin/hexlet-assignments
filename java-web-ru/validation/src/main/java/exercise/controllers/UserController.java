...
public final class UserController {
    ...
    public static Handler createUser = ctx -> {
        ...
        Validator<String> passwordValidator = ctx.formParamAsClass("password", String.class)
                .check(it -> StringUtils.isNumeric(it), "Пароль должно содержать только цифры")
                .check(it -> it.length() > 4 , "Пароль должен содержать более 4х символов");
        ...
        ctx.sessionAttribute("flash", "User успешно created");
        ctx.redirect("/users");
    };
}
